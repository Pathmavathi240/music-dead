...
def first_page(_):
	...
	first_page_menu = InlineKeyboardMarkup(
		[
			...
			[InlineKeyboardButton(text=_["H_B_7"], callback_data="help_callback hb7"), InlineKeyboardButton(text=_["H_B_8"], callback_data="help_callback hb8"),InlineKeyboardButton(text=_["H_B_15"], callback_data="help_callback hb15")],
			controll_button,
		]
	)
...
def second_page(_):
	...
	second_page_menu = InlineKeyboardMarkup(
		[
			...
			[InlineKeyboardButton(text=_["H_B_13"], callback_data="help_callback hb13"), InlineKeyboardButton(text=_["H_B_14"], callback_data="help_callback hb14")],
			controll_button,
		]
	)
